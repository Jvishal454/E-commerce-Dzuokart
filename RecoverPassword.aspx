        ...
        <div class="container"> 
              <div class="form-horizontal">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-3">
                          <asp:TextBox ID="txtNewPass" CssClass="form-control" TextMode="Password" runat="server" Width="385px" Visible="False"></asp:TextBox>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-3">
                          <asp:TextBox ID="txtConfirmPass" CssClass="form-control" TextMode="Password" runat="server" Width="385px" Visible="False"></asp:TextBox>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidatorConfirmPass" CssClass="text-danger" runat="server" ErrorMessage="Confirm Your New Password" ControlToValidate="txtConfirmPass" ForeColor="Red"></asp:RequiredFieldValidator>
                          <asp:CompareValidator ID="CompareValidatorPass" runat="server" ErrorMessage="Password does not match! try again" ForeColor="Red" ControlToCompare="txtNewPass" ControlToValidate="txtConfirmPass"></asp:CompareValidator>
